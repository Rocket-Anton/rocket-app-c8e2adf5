        ...
        <SidebarInset className="flex-1 p-0 m-0 border-0 overflow-hidden">
          <div className="h-full overflow-auto" style={{ scrollbarGutter: 'stable' }}>
            <div className="w-full max-w-7xl mx-auto p-6">
              <h2 className="text-2xl font-semibold mb-4">Abrechnen</h2>
              <p className="text-muted-foreground">Abrechnungsfunktionen werden hier implementiert.</p>
            </div>
          </div>
        </SidebarInset>
      </div>
