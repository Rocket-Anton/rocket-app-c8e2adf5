            ...
            <div className={`bg-background pt-2 pb-3 px-6 transition-transform duration-300 ${showFilter ? 'translate-y-0' : '-translate-y-full'}`}>
              <div className="flex items-center justify-between gap-2">
                ...
                <Popover open={mobileFiltersOpen} onOpenChange={setMobileFiltersOpen}>
                  ...
                  <PopoverContent 
                    className={`${isMobile ? 'w-screen max-w-[calc(100vw-2rem)]' : 'w-96'} max-h-[85vh] p-0 border shadow-lg bg-background z-50 overflow-hidden`}
                  ...
                  >
                    ...
                    {/* Scrollable Content */}
                    <ScrollArea className="max-h-[calc(85vh-65px)]" type="auto">
