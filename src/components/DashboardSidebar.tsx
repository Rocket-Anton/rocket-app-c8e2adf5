...
export const DashboardSidebar = () => {
  ...
  return (
    <>
      <Sidebar collapsible="icon" className={`border-r border-sidebar-border transition-all duration-300 ease-in-out ${state === "collapsed" ? "w-20" : ""}`} style={{ background: 'var(--sidebar-gradient)' }}>
