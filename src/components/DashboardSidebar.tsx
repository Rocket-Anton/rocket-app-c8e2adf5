          ...
          <SidebarGroup className="mt-0.5 pt-0.5 border-t border-sidebar-border">
            ...
            <SidebarGroupContent>
              <SidebarMenu className="space-y-0">
                    ...
                    <div className="space-y-0">
                      ...
                      >
                        <SidebarMenuButton
                          ...
                          className={`text-sidebar-foreground hover:bg-sidebar-accent rounded-xl py-0.5 ${location.pathname === "/settings/raketen" ? "bg-sidebar-accent" : ""}`}
                        >
                ...
                <SidebarMenuItem>
                  <SidebarMenuButton asChild className={`text-sidebar-foreground rounded-xl py-1 ${
                    state === "collapsed" 
                      ? "h-7 w-full mx-auto flex items-center justify-center hover:bg-sidebar-accent" 
                      : "justify-between hover:bg-sidebar-accent"
                  }`}>
