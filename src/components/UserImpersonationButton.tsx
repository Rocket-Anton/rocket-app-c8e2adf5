...
import impersonationIcon from '@/assets/user-impersonation-icon.png';
...
export const UserImpersonationButton = () => {
  ...
  return (
    <>
      <div className="hidden lg:block fixed bottom-6 left-[calc(var(--sidebar-width)+1.5rem)] z-50 transition-all">
        <Button
